...
setup(
    ...
    name="lightweight-versioned-gitlab-pages",  # Required
    ...
    description="Enable GitLab pages to provide documentation for multiple versions",
    ...
    # above.
    author_email="jonas@brainelectronics.de",  # Optional
    ...
    # larger catalog.
    keywords=[
        "gitlab", "version", "pages", "versioning", "generator", "documentation",
    ],
    ...
    # syntax, for example:
    #
    #   $ pip install lightweight-versioned-gitlab-pages[dev]
    #
    ...
    # },
    package_data={
        "lightweight_versioned_gitlab_pages": ["templates/*"]
    },
    ...
    entry_points={  # Optional
        "console_scripts": [
            "generate-versioned-pages=lightweight_versioned_gitlab_pages.generate:main",
        ],
    },
